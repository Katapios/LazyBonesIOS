...
struct SettingsView: View {
    ...
    private var autoSendSection: some View {
        Section(header: Text("Автоотправка отчетов")) {
            ...
            Text("Отчеты будут автоматически отправляться один раз в сутки, в период с 22:00 до 8:00 утра. Если какого-то отчета нет, будет отправлено соответствующее сообщение. Отправка происходит в фоне, когда система разрешит выполнение фоновой задачи.")
                .font(.caption)
                .foregroundColor(.secondary)
