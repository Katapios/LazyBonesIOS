...
- Добавить недостающие тесты: `SettingsViewModelNew` (расширить), `MainViewModelNew`, `ReportsViewModelNew` (покрыть углы), `TagManagerViewModelNew`, `PlanningViewModelNew`, формы
